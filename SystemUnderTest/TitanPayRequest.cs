...
namespace SystemUnderTest
{
    ...
    class TxtFileManager : IFileManager
    {
    ...
    class CurrentDateManager : IDateManager
    {
    ...
    {
        public IFileManager FileManager { get; set; } = new TxtFileManager();
        public IDateManager DateManager { get; set; } = new CurrentDateManager();
        ...
        public void Sign2()
        {
            var merchantKey = FileManager.GetMerchantKey();
            var beforeHash = $"{MerchantCode}{Amount:n0}{merchantKey}";
